...
evenfibs = sum (filter even (fibo 1 2))
...
calculateDigiProduct :: String -> Int
calculateDigiProduct s = product $ map digitToInt s
...
-- Join digit lines into one string 
thousandDigits = intercalate "" preDigits

-- Calculate 13 digit product
calcSubPart :: Int -> Int
calcSubPart from = calculateDigiProduct $ take 13 $ drop from thousandDigits

-- Iterate from left to right
generateProducts :: [Int]
generateProducts = [calcSubPart y | y <- [0,1..987]]

largestProd :: Int
largestProd = maximum $ generateProducts
